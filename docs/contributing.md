...
- Expand the Game Theory Knowledge Base
...
3. Add new concepts to `knowledge-base.js` following the established pattern
4. Test thoroughly in multiple browsers
5. Submit PR with clear description

**Note**: Do not introduce external heavy dependencies. Keep it lightweight and auditable.
