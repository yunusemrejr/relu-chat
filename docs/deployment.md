...
- `config.js` centralizes all thresholds and model configuration
- KB entries include `related` cross-references
- CSP meta tag added to chat HTML
- LRU cache replaces unbounded Map
- Pre-compiled alias regex for entity extraction
